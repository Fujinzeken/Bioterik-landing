...
const pillars = [
  {
    ...
    description:
      "Precisely quantified active compounds for consistent efficacy across every batch",
    icon: (
      <svg
        className="h-7 w-7"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Every formulation is backed by peer-reviewed research and clinical data",
    icon: (
      <svg
        className="h-7 w-7"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Enhanced absorption and utilization by the body for maximum therapeutic benefit",
    icon: (
      <svg
        className="h-7 w-7"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Multiple testing stages ensure purity, potency, and safety at every step",
    icon: (
      <svg
        className="h-7 w-7"
        fill="none"
      ...
      <div className="w-full max-w-[1280px] mx-auto px-8 md:px-12 lg:px-16">
        <RevealOnScroll className="text-center mb-20">
          ...
          <p className="text-[1rem] text-[var(--text-muted)] max-w-[520px] mx-auto leading-relaxed">
            Four pillars that distinguish us from conventional supplement
            manufacturers
          </p>
        </RevealOnScroll>

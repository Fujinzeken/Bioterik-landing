...
const reasons = [
  {
    ...
    description:
      "Team of qualified pharmacists with deep knowledge of pharmacokinetics and clinical efficacy. Every formulation is designed to deliver real, measurable results.",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Every ingredient listed, every dosage precise. No proprietary blends, no hiding. Complete transparency so healthcare professionals can prescribe with confidence.",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Sourced from Indena. Manufacturing follows EU pharmaceutical guidelines. Every batch undergoes rigorous testing to meet the highest quality benchmarks.",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
